...
/**
 * A directive which selects a [template](https://angular.io/docs/ts/latest/guide/template-syntax.html)
 * within the `<kendo-chart>` component that will be used for the
 ...
 * ```
 */
var DonutCenterTemplateDirective = (function () {
