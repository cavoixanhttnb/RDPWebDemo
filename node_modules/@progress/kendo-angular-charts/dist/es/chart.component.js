...
import { Component, ContentChild, NgZone, Optional, Inject, ChangeDetectionStrategy, ChangeDetectorRef, Renderer2 } from '@angular/core';
...
var ChartComponent = (function (_super) {
    ...
    function ChartComponent(configurationService, themeService, element, intl, ngZone, instanceEventService, changeDetector, renderer, rtl) {
    ...
    Object.defineProperty(ChartComponent.prototype, "dir", {
        get: function () {
    ...
    ChartComponent.prototype.ngAfterViewInit = function () {
        ...
        if (this.canRender) {
            this.ngZone.runOutsideAngular(function () {
                ...
                var tooltipMouseleave = _this.renderer.listen(_this.tooltipInstance.element.nativeElement, 'mouseleave', _this.tooltipMouseleave.bind(_this));
    ...
    ChartComponent.prototype.onShowTooltip = function (e) {
        var _this = this;
        //just detect changes if issue in popup with detect changes out of the zone is fixed
        this.run(function () {
            if (!e.crosshair) {
    ...
    ChartComponent.prototype.refreshWait = function () {
        var _this = this;
        this.ngZone.runOutsideAngular(function () {
            _this.subscription = _this.configurationService.onChange$.combineLatest(_this.themeService.onChange$, function (options, theme) {
