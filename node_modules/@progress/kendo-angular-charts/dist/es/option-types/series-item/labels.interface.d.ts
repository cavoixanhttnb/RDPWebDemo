...
export interface SeriesLabels {
    /**
     * The label alignment when [`series.type`]({% slug api_charts_series %}#toc-type) is set to `"donut"`, `"funnel"`, or `"pie"`.
     *
    ...
    /**
     * The distance of the labels when [`series.type`]({% slug api_charts_series %}#toc-type) is set to `"donut"` or `"pie"`.
     */
    distance?: number;
    /**
    ...
    font?: string;
    /**
     * The format of the labels. Uses the IntlService [`format`]({% slug api_intl_intlservice %}#toc-format) method.
     */
    format?: string;
    /**
