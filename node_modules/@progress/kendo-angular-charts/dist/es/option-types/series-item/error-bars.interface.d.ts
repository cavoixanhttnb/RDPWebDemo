...
export interface SeriesErrorBars {
    ...
    /**
     * The [`xAxis`]({% slug api_charts_xaxis %}) error bars value. For a list of the supported value
    ...
    xValue?: string;
    /**
     * The [`yAxis`]({% slug api_charts_yaxis %}) error bars value. For a list of supported value types, refer
