...
export interface ValueAxis {
    ...
    /**
     * The interval between minor divisions. It defaults to 1/5 of the [`valueAxis.majorUnit`]({% slug api_charts_valueaxis %}#toc-majorunit).
    ...
    minorUnit?: number;
    /**
     * The unique axis name. Used to associate a series with a value axis using the [`series.axis`]({% slug api_charts_series %}#toc-axis) option.
     */
    name?: string;
    /**
