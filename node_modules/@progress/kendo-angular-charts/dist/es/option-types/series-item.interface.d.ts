...
export interface Series {
     ...
     *
     * The border option is supported when [`series.type`]({% slug api_charts_series %}#toc-type) is set to `"bar"`, `"column"`, `"donut"`, `"pie"`, `"bubble"`,
     ...
     *
     * The `dashType` option is taken into consideration only if the [`series.type`]({% slug api_charts_series %}#toc-type) option is set to `"line"`.
     *
     ...
     *
     * The `missingValues` option is supported when [`series.type`]({% slug api_charts_series %}#toc-type) is set to `"area"`, `"rangeArea"`, `"line"`, `"scatterLine"`,
     ...
     *
     * The `openField` option is supported when [`series.type`]({% slug api_charts_series %}#toc-type) is set to `"candlestick"` or `"ohlc"`.
     */
    openField?: string;
    /**
     ...
     *
     * The padding option is supported when [`series.type`]({% slug api_charts_series %}#toc-type) is set to `"donut"` or `"pie"`.
     */
    padding?: number;
    /**
     ...
     *
     * The style option is supported when [`series.type`]({% slug api_charts_series %}#toc-type) is set to `"line"`, `"scatterLine"`, `"radarLine"`, or
     * `"polarLine"`.
     *
     * The step value is only supported when [`series.type`]({% slug api_charts_series %}#toc-type) is set to `"line"`.
     *
     ...
     * For more information, refer to [series.outliers]({% slug api_charts_series %}#toc-outliers).
     */
     ...
     *
     * The Chart displays the series labels when the [s`eries.markers.visible`]({% slug api_charts_seriesmarkers %}#toc-visible) option is set to `true`.
     ...
     * For more information, refer to [`series.extremes`]({% slug api_charts_series %}#toc-extremes).
     */
    outliers?: SeriesOutliers;
    /**
     * The configuration options of the chart series tooltip.
     *
     * The Chart series tooltip is displayed when the [`series.tooltip.visible`]({% slug api_charts_seriestooltip %}#toc-visible) option is set to `true`.
     */
