...
export interface ValueAxisCrosshair {
     ...
     *
     * The crosshair tooltip is displayed when the [`valueAxis.crosshair.tooltip.visible`]({% slug api_charts_valueaxiscrosshairtooltip %}#toc-visible) option is set to
     * `true`.
     */
