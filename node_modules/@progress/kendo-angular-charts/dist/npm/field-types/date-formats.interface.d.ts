...
export interface DateFormats {
    /**
     * The format to use when the axis `baseUnit` is set to `"milliseconds"`.
     */
    milliseconds?: string;
    /**
     * The format to use when the axis `baseUnit` is set to `"seconds"`.
     */
    seconds?: string;
    /**
     * The format to use when the axis `baseUnit` is set to `"minutes"`.
     */
    minutes?: string;
    /**
