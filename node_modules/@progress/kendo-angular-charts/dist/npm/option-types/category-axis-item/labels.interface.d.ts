...
export interface CategoryAxisLabels {
     ...
     * The Chart chooses the appropriate format for the current [`categoryAxis.baseUnit`]({% slug api_charts_categoryaxis %}#toc-baseunit) option.
     * Setting the [`categoryAxis.labels.format`]({% slug api_charts_categoryaxislabels %}#toc-format) option overrides the date formats.
     *
     * For more information, refer to the IntlService [`format`]({% slug api_intl_intlservice %}#toc-format) method.
     *
