...
export interface CategoryAxis {
     ...
     *
     * This option is ignored if [`categoryAxis.baseUnit`]({% slug api_charts_categoryaxis %}#toc-baseunit) is set to `"fit"`.
     */
     ...
     *
     * This option is ignored if the [`series.type`]({% slug api_charts_series %}#toc-type) option is set to `"bar"`, `"column"`, `"boxPlot"`, `"ohlc"`,
    ...
    /**
     * The unique axis name. Used to associate a series with a category axis using the [`series.categoryAxis`]({% slug api_charts_series %}#toc-categoryaxis)
     * option.
     */
    name?: string;
    /**
