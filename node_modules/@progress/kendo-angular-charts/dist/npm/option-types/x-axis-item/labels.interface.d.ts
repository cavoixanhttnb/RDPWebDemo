...
export interface XAxisLabels {
    ...
    culture?: string;
    /**
     * The format used to display the labels when the X values are dates. Uses the IntlService [`format`]({% slug api_intl_intlservice %}#toc-format) method.
     * Contains one placeholder (`"{0}"`) which represents the category value.
     *
     * The Chart chooses the appropriate format for the current [`xAxis.baseUnit`]({% slug api_charts_xaxis %}#toc-baseunit). Setting the
    ...
    font?: string;
    /**
     * The format used to display the labels. Uses the IntlService [`format`]({% slug api_intl_intlservice %}#toc-format) method.
     * Contains one placeholder (`"{0}"`) which represents the category value.
     */
    format?: string;
    /**
