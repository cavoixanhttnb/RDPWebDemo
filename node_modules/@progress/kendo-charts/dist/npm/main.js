...
var Chart = (function (Class$$1) {
    ...
    Chart.prototype.getSize = function getSize () {
        ...
        var width = chartArea.width || Math.floor(this.element.offsetWidth);
        var height = chartArea.height || Math.floor(this.element.offsetHeight);
...
var Gauge = (function (Class$$1) {
    ...
    Gauge.prototype.value = function value (value) {
...
var RadialScale = (function (NumericAxis$$1) {
    ...
    RadialScale.prototype.radius = function radius (radius) {
        if (radius) {
